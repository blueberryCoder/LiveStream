package com.blueberry.media.yuv;
...
public class Yuv420Util {
    ...
    public static void onlyCopy(byte[] data, byte[] dstData, int w, int h) {
        System.arraycopy(data,0,dstData,0,dstData.length);
    }
     ...
     * @param w
     * @param h
     * @param degree {@link RotateMode}
     * @return
     */
    public static native int I420Rotate(byte[] data, byte[] dstData, int w, int h, int degree);
}
